...
namespace Web
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext<AdressManager>(AdressManager.Create);
            app.CreatePerOwinContext<ProductManager>(ProductManager.Create);
            app.CreatePerOwinContext<OrderManager>(OrderManager.Create);
